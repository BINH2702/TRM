...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate CL learnability-gate checkpoints on Task A/B test splits.")
    parser.add_argument("--a-only-checkpoint-dir", required=True)
    ...
    checkpoint_dirs = {
        "a_only": Path(args.a_only_checkpoint_dir),
        "b_only": Path(args.b_only_checkpoint_dir),
